...
namespace nordelta.cobra.webapi.Migrations
{
    ...
    [Migration("20230714190305_AddRazonSocialAndClientReferenceColumnToAccountBalanceModel")]
    partial class AddRazonSocialAndClientReferenceColumnToAccountBalanceModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.ArchivoDeuda.DetalleDeuda", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("ArchivoDeudaId"));
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.Bono", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.CvuEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CvuValue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ItauCreationTransactionId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.HistoricQuotations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PaymentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreditingDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SubOperationId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PaymentMethod", b =>
                {
                    ...
                    b.Property<string>("LockboxName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OlapAcuerdo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OlapMethod")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PaymentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ReportDateVto")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PublishClient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PublishedDebtBankFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NroArchivo")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("PublishedDebtBankFile");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.ValidacionCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AccOrigSystemReference")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AccountNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CasOrigSystemReference")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerFlag")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DefaultRegistrationFlag")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("JgzzFiscalCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LocAttribute1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LocationOsdr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OrgOrigSystemReference")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PartyCreationDate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PartySiteOsdr")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RefAcctBu")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SiteUseNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SupplierFlag")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ValidacionCliente");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.ARSUYU", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("ARSUYU");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.BTC", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("BTC");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.BTCARS", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("BTCARS");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.Cash", b =>
                {
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.Cheque", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.PaymentMethod");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.CvuOperation", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.PaymentMethod");

                    b.Property<string>("CoelsaId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("CvuEntityId")
                        .HasColumnType("int");

                    b.HasIndex("CvuEntityId");

                    b.HasDiscriminator().HasValue("CvuOperation");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.DebtFree", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.NotificationType");

                    b.HasDiscriminator().HasValue("DebtFree");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.Echeq", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.PaymentMethod");

                    b.HasDiscriminator().HasValue("Echeq");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.ETH", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("ETH");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.ETHARS", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("ETHARS");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.EUR", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("EUR");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.EURUSD", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("EURUSD");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.QuotationExternal", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("QuotationExternal");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.USD", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("USD");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.USDTARS", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("USDTARS");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.USDTUSD", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("USDTUSD");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.USDUYU", b =>
                {
                    b.HasBaseType("nordelta.cobra.webapi.Models.Quotation");

                    b.HasDiscriminator().HasValue("USDUYU");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.ArchivoDeuda.DetalleDeuda", b =>
                {
                    ...
                    b.HasOne("nordelta.cobra.webapi.Models.PaymentMethod", "PaymentMethod")
                        .WithMany("Debts")
                        .HasForeignKey("PaymentMethodId");

                    b.HasOne("nordelta.cobra.webapi.Models.PaymentReport", "PaymentReport")
                        .WithMany("Debts")
                        .HasForeignKey("PaymentReportId");

                    b.Navigation("ArchivoDeuda");
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PublishDebtRejectionError", b =>
                {
                    ...
                    b.Navigation("PublishDebtRejection");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.CvuOperation", b =>
                {
                    b.HasOne("nordelta.cobra.webapi.Models.CvuEntity", "CvuEntity")
                        .WithMany("CvuOperations")
                        .HasForeignKey("CvuEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CvuEntity");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.CvuEntity", b =>
                {
                    b.Navigation("CvuOperations");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.Notification", b =>
                {
                    b.Navigation("NotificationUserList");
                });

            modelBuilder.Entity("nordelta.cobra.webapi.Models.NotificationType", b =>
                {
                    b.Navigation("NotificationTypeRoles");
                });
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Models.PublishDebtRejectionFile", b =>
                {
                    b.Navigation("PublishDebtRejections");
                });
