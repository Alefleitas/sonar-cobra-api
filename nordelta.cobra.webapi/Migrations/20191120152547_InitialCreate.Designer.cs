...
namespace nordelta.cobra.webapi.Migrations
{
    ...
    [Migration("20191120152547_InitialCreate")]
            ...
            modelBuilder.Entity("nordelta.cobra.webapi.Services.DTOs.DetalleDeuda", b =>
                {
                    ...
                    b.HasIndex("ArchivoDeudaId", "NroComprobante", "FechaPrimerVenc", "CodigoMoneda", "ObsLibreSegunda", "NroCuitCliente")
                        .IsUnique()
                        .HasFilter("[NroComprobante] IS NOT NULL AND [FechaPrimerVenc] IS NOT NULL AND [CodigoMoneda] IS NOT NULL AND [ObsLibreSegunda] IS NOT NULL AND [NroCuitCliente] IS NOT NULL");
