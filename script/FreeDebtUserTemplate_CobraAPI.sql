INSERT INTO [TST_COBRA].[dbo].[Template] ([Subject], [Description], [HtmlBody], [Disabled])
...
<body style="background-color: rgb(246, 246, 246); padding: 20px;">
    <div style="max-width: 560px; margin: 0 auto; background-color: white; padding: 20px 40px;">
        ...
        <h1>
         ...
         <h3><span style="background-color: transparent;">Nos alegra informarte que has finalizado tu plan de pagos.<br><br>
